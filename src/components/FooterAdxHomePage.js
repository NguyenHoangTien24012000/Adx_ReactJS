            ...
            <div className="footer-content">
                ...
                <div className="footer-contact">
                    ...
                    <div className="social-media">
                        <div className="logo-contact space-right"><img src={require('../assets/images/Vector.png')} alt="facebook" /></div>
                        <div className="logo-contact space-right"><img src={require('../assets/images/Vector (1).png')} alt="skype" /></div>
                        <div className="logo-contact logo-zalo space-right"><img src={require('../assets/images/image 152.png')} alt="zalo" /></div>
                    </div>
                </div>
                <div className="footer-address">
                    <div className="address-shared">
                        <h3>Văn phòng Hà Nội</h3>
                        <div className="address-detail"><img src={require('../assets/images/Vector (4).png')} alt="address" />
